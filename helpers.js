function init(e){
    $('<div class="modal-backdrop custom_backdrop"><img src="//codecloud.cdn.speedyrails.net/sites/5d6ff83a6e6f641ac81a0000/image/gif/1565879091860/loading.gif" class="" alt=""></div>').appendTo(document.body);
